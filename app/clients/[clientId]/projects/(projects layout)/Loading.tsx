const Loading: React.FC<{ skeletonCount: number; width?: number }> = (
  props
) => {
  const skeletonCount = isNaN(props.skeletonCount) ? 9 : props.skeletonCount - 1 // * We subtract 1 because we already have one skeleton element before the loop
